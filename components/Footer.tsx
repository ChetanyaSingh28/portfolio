...
export default function Footer() {
  return (
    <motion.footer
      ...
      variants={fadeInUp}
      className="relative py-16 border-t border-[#222222] bg-[#000000]"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <Magnetic>
            <a
              href="#hero"
              className="text-2xl font-bold font-mono text-white tracking-tight mb-6 hover:text-[#94a3b8] transition-colors p-2"
            >
              CS
            </a>
          </Magnetic>
          ...
          {/* Divider */}
          <div className="w-full max-w-[100px] h-px bg-[#333333] mb-8" />

          {/* Copyright */}
          <p className="text-xs text-[#64748b] font-mono tracking-widest uppercase">
            &copy; 2026 Chetanya Singh. All rights reserved.
          </p>
        </div>
      </div>
    </motion.footer>
